...
export function defineRoutes(
  ...
  //   - External AG-UI path: the adapter is the authority on reachability and we
  //     cannot cheaply probe it per data source, so we report available and let
  //     the runtime error path handle an adapter rejection.
  ...
  // hides a button that today's gates would still show; only a definitive
